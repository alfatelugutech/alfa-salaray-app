...
import SafeAttendanceDashboard from './pages/SafeAttendanceDashboard'
...
function App() {
  ...
  return (
    <>
      <Layout>
        <Routes>
        <Route path="/" element={<SafeAttendanceDashboard />} />
        <Route path="/dashboard" element={<SafeAttendanceDashboard />} />
