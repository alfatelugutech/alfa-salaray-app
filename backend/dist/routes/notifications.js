...
router.patch('/preferences', async (req, res) => {
    try {
        ...
        const validationSchema = joi_1.default.object({
            ...
            attendanceReminders: joi_1.default.boolean(),
            leaveNotifications: joi_1.default.boolean(),
            payrollNotifications: joi_1.default.boolean(),
            systemNotifications: joi_1.default.boolean()
        });
...
router.post('/send', async (req, res) => {
    try {
        ...
        const validationSchema = joi_1.default.object({
            ...
            type: joi_1.default.string().valid('INFO', 'WARNING', 'ERROR', 'SUCCESS').required(),
