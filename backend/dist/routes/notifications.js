...
const sendNotificationSchema = joi_1.default.object({
    type: joi_1.default.string().valid('email', 'sms', 'push', 'whatsapp').required(),
...
const notificationPreferencesSchema = joi_1.default.object({
...
// Helper functions
async function sendEmailNotification(recipient, subject, message, template, data) {
    try {
